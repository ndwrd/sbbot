...
RUN apk add --no-cache --update php81 \
    ...
    && rm -rf /linux-amd64 \
    && wget https://github.com/SagerNet/sing-box/releases/download/v1.14.0/sing-box-1.14.0-linux-amd64.tar.gz \
    && tar -xf sing-box-1.14.0-linux-amd64.tar.gz \
    && mv sing-box-1.14.0-linux-amd64/sing-box /usr/bin \
    && rm sing-box-1.14.0-linux-amd64.tar.gz \
    && rm -rf /sing-box-1.14.0-linux-amd64 \
